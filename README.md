...
[Provide feedback on this code example.](https://cypress.co1.qualtrics.com/jfe/form/SV_1NTns53sK2yiljn?Q_EED=)
...
The following example clones the "[mtb-example-ce241830-dma-1d-transfer](https://github.com/Infineon/mtb-example-ce241830-dma-1d-transfer)" application with the desired name "Dma1dTransfer" configured for the *KIT_PSOC4-HVMS-128K_LITE* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSOC4-HVMS-128K_LITE --app-id mtb-example-ce241830-dma-1d-transfer --user-app-name Dma1dTransfer --target-dir "C:/mtb_projects"
   ```
